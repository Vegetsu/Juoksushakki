...
/*
Määrittelee sotilaalle ominaiset ehdot, käyttäen apuna nappuloille yleistä Piece luokkaa.
 */
public class Sotilas extends Piece {


    /*
    Asettaa sotureille niille kuuluvat värit.
     */
    public Sotilas(String color) {
        super(color);
    }
    ...
    /*
    Määrittelee, että mitkä ovat laillisia liikkeitä sotilaalle.
     */
    @Override
