...
public class Aloitusruutucontroller {
    ...
    public void initialize() {
        ...
        valkoinenpelaajaTextfield.setOnAction(e -> handleEnter());

        mustapelaajaTextfield.setOnAction(e -> handleEnter());
    }
    ...
    private void startGame() throws IOException {
        ...
        stage.setOnCloseRequest(e -> {
            pelintallennus.kirjoitaLopputulos(
                    "Peli keskeytettiin: ohjelma suljettiin."
            );
            ...
            pelintallennus.peliMuistiin(
                    white,
                    black
            );
            controller.soundManager.play("start");
        controller.setPelintallennus(pelintallennus);
            /*
    ...
    private void handleEnter() {
        ...
        if (valkoinenpelaajaTextfield.getText().isBlank()) {
            valkoinenpelaajaTextfield.requestFocus();
            return;
        }

        if (mustapelaajaTextfield.getText().isBlank()) {
            mustapelaajaTextfield.requestFocus();
            return;
        }


        aloitusruutubutton.fire();
    }

    private Pelintallennus pelintallennus = new Pelintallennus();
    }
