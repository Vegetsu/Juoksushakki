 ...
 */
        ...
        /*
Tarkistetaan, onko potentiaalinen liike ohestasyöntiliike, ja jos on niin suoritetaan liike ja lisätään se siirtohistoriaan.
Lopuksi vaihdetaan vuoro.
 */
 ...
 */
    ...
    /*
Tarkistaa, että onko liike ohestasyöntiliike. Oman sotilaan täytyy olla liikkunut kolme ruutua lähtöruudustaan ja vastustajan
 ...
 */
    public List<int[]> getLegalMoves(int row, int col) {
        ...
        /*
        Jos kyseinen nappula on sotilas, niin tarkastetaan lisäksi, että onko ohestasyöntiliike sille mahdollinen.
         */
        if (piece instanceof Sotilas) {
    ...
    /*
    Tarkistaa, että onko ohestasyöntiliike mahdollista suorittaa. Vastustajan viimeksi siirretty nappula täytyy olla sotilas
